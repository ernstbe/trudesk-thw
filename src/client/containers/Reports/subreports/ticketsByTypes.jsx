  ...
  const onFormSubmit = e => {
    ...
    dispatch(
      generateReport({
        ...
        filename: `report_tickets_by_type__${dayjs(startDate).format('MMDDYYYY')}`,
        startDate,
        endDate,
      ...
      <TruCard
        ...
        header={
          <div style={{ padding: '10px 15px' }}>
            <h4 style={{ width: '100%', textAlign: 'left', fontSize: '14px', margin: 0 }}>Tickets by Types</h4>
          </div>
        }
            ...
            <div className='padding-15'>
              <form onSubmit={e => onFormSubmit(e)}>
                <Grid>
                  ...
                  <GridItem width='1-1'>
                    <div className='uk-margin-medium-top uk-margin-medium-bottom'>
                      <label htmlFor='priorities'>Types</label>
                      <SingleSelect
                        multiple
                        items={types}
                        value={selectedTypes}
...
export default ReportTicketsByTypes
