...
const NoticeAlertModal = ({ notice, noticeCookieName, shortDateFormat, timeFormat, hideModal, ...rest }) => {
  const onConfirmClick = useCallback((e) => {
    ...
    Cookies.set(noticeCookieName, 'false', { expires: expiresDate })
    hideModal('NOTICE_ALERT')
  }, [noticeCookieName, hideModal])
