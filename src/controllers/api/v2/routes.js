...
module.exports = function (middleware, router, controllers) {
  ...
  router.post('/api/v2/accounts/profile/picture', apiv2Auth, apiv2.accounts.uploadProfileImage)
  ...
  router.get('/api/v2/tickets/stats/workload', apiv2Auth, canUser('tickets:view'), apiv2.tickets.getWorkloadStats)
